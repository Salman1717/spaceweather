            ...
            body: SingleChildScrollView(
                child:Center(child:Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 20),
                    ImgCard(img: 'arview/Earth1.avif', title: 'EARTH',destination: EarthAr()),
                    SizedBox(height:30),
                    ImgCard(img: 'arview/Moon.avif', title: 'MOON',destination: MoonAr()),
                    SizedBox(height:30),
                    ImgCard(img: 'arview/Mars.avif', title: 'MARS',destination: MarsAr()),
                    SizedBox(height:30),
                    ...
                    SizedBox(height:30),
                    ImgCard(img: 'arview/Jupiter.avif', title: 'JUPITER',destination: JupiterAr()),
                    SizedBox(height:30),
                    ImgCard(img: 'arview/Saturn.avif', title: 'SATURN',destination: SaturnAr()),
                    SizedBox(height:30),
