            ...
            body: SingleChildScrollView(
                child:Center(child:Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 20),
                    ImgCard(img: 'arview/Earth11.jpg', title: 'EARTH',destination: EarthAr()),
                    SizedBox(height:30),
                    ImgCard(img: 'arview/Moon22.jpg', title: 'MOON',destination: MoonAr()),
                    SizedBox(height:30),
                    ImgCard(img: 'arview/Mars33.jpg', title: 'MARS',destination: MarsAr()),
                    SizedBox(height:30),
                    ...
                    SizedBox(height:30),
                    ImgCard(img: 'arview/Jupiter66.jpg', title: 'JUPITER',destination: JupiterAr()),
                    SizedBox(height:30),
                    ImgCard(img: 'arview/Saturn77.jpg', title: 'SATURN',destination: SaturnAr()),
                    SizedBox(height:30),
